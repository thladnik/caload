...
#     """
#     Recursively parse the tokens into a nested dictionary (AST). Handles nested parentheses, NOT, and IN operator.
#     """
#
...
#                     current_expr.append({'IN': [left_operand, right_operand]})
#                 else:
#                     right_operand = tokens.pop(0)
#                     current_expr.append({'IN': [left_operand, right_operand]})
#             else:
...
def _generate_attribute_filters(entity_type: Type[Union[Animal, Recording, Roi, Phase]], session: Session,
    ...
    TODO: currently supported operations are nested trees of: AND, OR, IN, EXIST, <=, <, ==, >, >=
    """
